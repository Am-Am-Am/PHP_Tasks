...
// 1. Запрос для получения отца и сына вместе с пользователем:
$query1 = "SELECT p1.name AS person, p2.name AS father, p3.name AS son
            ...
            ";
// 2. Запрос для получения дедушки пользователя
$query2 = "SELECT p3.name AS grandson, p2.name AS son, p1.name AS grandfather
            ...
            WHERE p3.name = 'Внук';
            ";
// 3. Запрос для получения прадедушки пользователя:
